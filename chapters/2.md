...
<!-- any wording here -->
```javascript
var mySprite = Sprite.create("Blue_Front1.png");

// Move a sprite 50 pixels to the right, and 10 pixels to the top over 2 seconds.
var moveBy = MoveBy::create(2, Vec2(50,10));
mySprite.runAction(moveBy);

// Move a sprite to a specific location over 2 seconds.
var moveTo = MoveTo.create(2, Vec2(50,10));
mySprite.runAction(moveTo);
```
...
<!-- any wording here -->
```javascript
var mySprite = Node.create()

// move to point 50,10 over 2 seconds
var moveTo1 = MoveTo.create(2, Vec2(50,10));

// move from current position by 100,10 over 2 seconds
var moveBy1 = MoveBy.create(2, Vec2(100,10));

// move to point 150,10 over 2 seconds
var moveTo2 = MoveTo.create(2, Vec2(150,10));
