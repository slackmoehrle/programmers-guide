...
Although it is more flexible than a _bitmap font_, a _true type font_ is slower to render and changing properties like the _font face_ and _size_ is an expensive operation.
