...
<!-- insert any language specific wording here, i.e language specific to C++ or JavaScript -->
```javascript
var mySprite = new Sprite("mysprite.png", Rect(0,0,40,40));
```
...
var mySprite = new Sprite("mysprite.png", Rect(0,0,200,200));
```
...
```javascript
// load the Sprite Sheet
var spritecache = SpriteFrameCache::getInstance();
...
// Our .plist file has names for each of the sprites in it.  We'll grab
// the sprite named, "Blue_Front1" from the sprite sheet:
var mysprite = new Sprite::createWithSpriteFrameName("Blue_Front1.png");
```
