...
Neighbor chunks which have different LOD levels may cause the `crack` artifacts. `Terrain` provide two approaches to avoid them--the `Terrain::CrackFixedType::SKIRT` and the
