...
auto _textureCube = TextureCube::create("skybox/left.jpg",  "skybox/right.jpg","skybox/top.jpg","skybox/bottom.jpg",
...
Neighboring chunks of `Terrain` ojects, which have different __LOD__ may cause the __crack__ artifacts. `Terrain` provide two functions to avoid them -- the `Terrain::CrackFixedType::SKIRT` and the `Terrain::CrackFixedType::INCREASE_LOWER`.
