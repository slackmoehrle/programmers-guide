...
##Cubemap Texture
A cube map texture is a collection of six separate square textures that are put onto the faces of an imaginary cube. Most often they are used to display infinitely far away reflections on objects, similar to how sky box displays far away scenery in the background。An expanded cube map texture as bellow.

![](9-img/Cubemap.jpg)

In cocos2dx,you can create cube map in this way:
